...
export const routes: Routes = [
  { path: 'home', component: Home }, // ruta raíz: '' al componente "Home",
  { path: '', redirectTo: 'home', pathMatch: 'full' }, // ruta de redirección al componente "Home". Trabaja el atributo pathMatch.
